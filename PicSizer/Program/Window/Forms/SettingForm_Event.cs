...
namespace PicSizer.Program.Window.Forms
{
    public partial class SettingForm
    {
        ...
        private void LoadSetting()
        {
            ...
            numericUpDown_Quality.Value = PicSetting.Quality; //指定画质
        ...
        private void SaveSetting()
        {
            ...
            PicSetting.Quality = (int)numericUpDown_Quality.Value; //指定画质
            PicSetting.LimitSize = comboBox_KB_or_MB.SelectedIndex == 0
                ? (long)numericUpDown_Size.Value
                : (long)numericUpDown_Size.Value * 1024; //指定大小
